                    ...
                    <div class="row">
                        <div class="col-6">
                            <p class="card-info-text">
                                <img class="card-info-icon" src="@/assets/img/icon_Date.png" alt="" /> date
                            </p>
                        </div>
                        <div class="col-6">
                            <p class="card-info-text">
                                <img class="card-info-icon" src="@/assets/img/icon_Location.png" alt="" /> location
                            </p>
                        </div>
                    </div>
                    <p class="card-title">event.title</p>
                    <p class="card-detail">Details about Card 2.</p>
                    <p class="card-price">30,000 KRW</p>
                </div>
            </div>
            ...
            <div class="create-form">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ipnut-question" placeholder="Your answer:" name="" id=""></textarea>
                    </div>
                    ...
                    <div class="agreement-container">
                        ...
                        <!-- Join Now 버튼 -->
                        <button class="join-now-button" :disabled="!isChecked">Submit event</button>
                    </div>
            ...
            <div class="create-form-op2">
                <form>
                    ...
                    <div class="agreement-container">
                        ...
                        <!-- Join Now 버튼 -->
                        <button class="join-now-button-op2" :disabled="!isChecked">Submit event</button>
                    </div>
