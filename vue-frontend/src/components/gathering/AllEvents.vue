  ...
  <div class="Web">
    ...
    <div class="container why-con">
      <div class="row">
        ...
        <div class="col-6 why-box">
          ...
          <p class="wc-text2">
            Lorem ipsum dolor sit amet consectetur erat elit viverra quis vestibulum auctor sit tellus est quam quis
            urna id at nunc amet dolor hendrerit justo.
          </p>
          <router-link to="/">
    ...
    <div class="testimonials-grid review-row1">
      ...
      <div class="testimonial-card">
        ...
        <p class="testimonial-text">
          Lorem ipsum dolor sit amet ipsum non consectetur adipiscing elit hendrerit elit at a at cursus nibh lorem
          aliquam.
        </p>
      </div>
