 ...
 <div class="container">
    ...
    <tr>
      <th>
        ...
        <button class="submit-btn" type="submit">
          <img class="submit-btn-img" src="../vue-frontend/src/assets/Search-icon.png" alt="">
        </button>
      </th>
      <th>
  ...
  <div class="row title-box">
    ...
    <div class="col-6 text-right">
      <img src="../vue-frontend/src/assets/icons/Graph.png" alt="">
...
<script>
import EventCard from "../vue-frontend/src/components/gathering/EventCard.vue";
