    ...
    <body>
        <div class="mobile">
                <div class="container mobile-login">
                    <div class="row">
                        <div class="col">
                            <router-link to="/"><img class="back-icon" src="../vue-frontend/src/assets/Union.png" alt=""></router-link>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row m-or-box">
                        <img class="m-or-line" src="../vue-frontend/src/assets/Line%201.png" alt="">
                        <p class="m-or-text">or</p>
                        <img class="m-or-line" src="../vue-frontend/src/assets/Line%201.png" alt="">
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <button class="m-login-btn3" type="button" @click="handleGoogleLogin"><img class="m-icon-google" src="../vue-frontend/src/assets/icon_google.png" alt="">Log in with Google</button>
                        </div>
                    </div>
                                ...
                                <div class="login-box2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 login-icon-box">
                                            <button class="login-btn" @click="handleGoogleLogin"><img class="login-google-icon" src="../vue-frontend/src/assets/icon_google.png" alt="">Login with Google</button>
                                        </div>
